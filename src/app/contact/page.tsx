      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="grid gap-2">
          ...
          <select
            ...
            required
            defaultValue=""
            className="border border-bronze/25 bg-ivory px-4 py-3 text-sm text-charcoal focus:border-bronze focus:outline-none transition-colors duration-200"
          >
        ...
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 lg:py-16">
          <div className="grid gap-px bg-bronze/10 sm:grid-cols-2 lg:grid-cols-4">
            {contactMethods.map((method) => {
              const inner = (
                <div className="group relative flex flex-col overflow-hidden bg-ivory p-7 transition-colors duration-300 hover:bg-[#f3ede4] sm:p-8">
                  <div className="absolute left-0 top-0 h-[2px] w-0 bg-bronze transition-all duration-700 group-hover:w-full" />
                  <div className="mb-5 text-bronze">{method.icon}</div>
                  <p className="text-[0.58rem] uppercase tracking-[0.28em] text-bronze/70 transition-colors duration-300 group-hover:text-bronze">
                    {method.label}
                  </p>
                  <p className="mt-2 font-serif text-lg leading-tight text-charcoal">
                    {method.value}
                  </p>
                  <p className="mt-1 text-xs text-charcoal/45">{method.sub}</p>
                  {method.href && (
                    <span className="mt-5 text-[0.58rem] uppercase tracking-[0.2em] text-bronze/60 transition-all duration-300 group-hover:translate-x-1 group-hover:text-bronze">
                      Contacter →
                    </span>
                  )}
                </div>
